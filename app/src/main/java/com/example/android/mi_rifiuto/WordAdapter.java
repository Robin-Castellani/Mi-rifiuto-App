...
public class WordAdapter extends ArrayAdapter<Word> {
     ...
     * @param wordList ArrayList containing elements of Word type (waste name and description)
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // first the waste name
        TextView wasteTextView = listItemView.findViewById(R.id.miwok_text_view);
        wasteTextView.setText(currentWord.getWaste());

        // then the description
        TextView descriptionTextView = listItemView.findViewById(R.id.default_text_view);
